    ...
    def md5Markdown(line):
        ...
        while "[[" in line and "]]" in line:
            ...
            for l in range(len(line)):
                if not l == len(line) - 1 and line[l] == '[' and line[l + 1] == '[':
                    rep.append(l)
                elif not l == len(line) - 1 and line[l] == "]" and line[l + 1] == ']':
                    rep.append(l)
            if rep:
        ...
        for k, line in enumerate(read):
            ...
            if lineSplit[0] in markD:
                ...
                # Lists
                    ...
                    if k is len(read) - 1 or not read[k + 1].startswith("{} ".format(first)):
                        toWrite = "</{}>\n".format(tag)
                        fw.write(toWrite)
                        first = 0
            else:
                ...
                if line[0] != "\n":
                    ...
                    if k != len(read) - 1 and read[k + 1][0] != "\n" and read[k + 1][0] not in markD:
                        fw.write("<br/>\n")
                    else: 
                        fw.write("</p>\n")
                        f = 0
